...
module.exports = class tomodex extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                ...
                'api': {
                    'public': 'https://dex.tomochain.com/api',
                    'private': 'https://dex.tomochain.com',
                },
                'doc': 'https://apidocs.tomochain.com/#tomodex-apis',
                'www': 'https://tomochain.com',
            },
            'api': {
                'matcher': {
                    'get': [
